About srtm.py-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/srtm.py-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1962&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/srtm.py-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `srtm.py` can be installed with `conda`:
...
```
mamba install srtm.py
```

It is possible to list all of the versions of `srtm.py` available on your platform with `conda`:
...
```
mamba search srtm.py --channel conda-forge
```
...
mamba repoquery search srtm.py --channel conda-forge

# List packages depending on `srtm.py`:
mamba repoquery whoneeds srtm.py --channel conda-forge

# List dependencies of `srtm.py`:
mamba repoquery depends srtm.py --channel conda-forge
```
